...
.then (data => {
    ...
    eventosFiltradosUp = info.events.filter((filtro))

    containerCardUpcoming.innerHTML = crearTemplateEventos (eventosFiltradosUp)
...
function dobleFiltro (){
    ...
    let filtrarPorBusqueda = filtrarPorNombre (eventosFiltradosUp, inputBusqueda.value )
